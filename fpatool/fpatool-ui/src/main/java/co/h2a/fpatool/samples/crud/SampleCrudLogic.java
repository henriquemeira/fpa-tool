package co.h2a.fpatool.samples.crud;

import co.h2a.fpatool.FPAUI;
import co.h2a.fpatool.samples.backend.DataService;
...
public class SampleCrudLogic implements Serializable {
    ...
    public void init() {
        ...
        if (!FPAUI.get().getAccessControl().isUserInRole("admin")) {

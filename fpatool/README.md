...
- fpatool-widgetset: widgetset, custom client side code and dependencies to widget add-ons
- fpatool-ui: main application module, development time
- fpatool-production: module that produces a production mode WAR for deployment

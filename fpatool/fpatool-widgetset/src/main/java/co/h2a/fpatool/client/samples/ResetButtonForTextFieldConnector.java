package co.h2a.fpatool.client.samples;
...
import co.h2a.fpatool.samples.ResetButtonForTextField;
...
public class ResetButtonForTextFieldConnector extends
    ...
    /*-{
        ...
        el.onclick = $entry(function () {
            self.@co.h2a.fpatool.client.samples.ResetButtonForTextFieldConnector::clearTextField()();
        });
    }-*/;
